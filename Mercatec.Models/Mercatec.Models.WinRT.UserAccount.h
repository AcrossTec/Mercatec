...
namespace winrt::Mercatec::Models::implementation
{
    ...
    public:
        ...
        void PassportDevices(const IObservableVector<Models::PassportDevice>& devices) noexcept;

        IObservableVector<Models::PassportDevice> PassportDevices() const noexcept;

    public:
        ::Mercatec::Models::UserAccount m_Model;

    private:
        IObservableVector<Models::PassportDevice> m_PassportDevices;
    };
} // namespace winrt::Mercatec::Models::implementation
