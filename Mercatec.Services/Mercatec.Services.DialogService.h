...
namespace winrt::Mercatec::Services::implementation
{
    ...
    {
        DialogService();
        IAsyncOperation<bool> ShowAsync(const std::wstring_view title, const std::wstring_view content);
        IAsyncOperation<bool> ShowAsync(const std::wstring_view title, const std::wstring_view content, const std::wstring_view ok);
        IAsyncOperation<bool> ShowAsync(const std::wstring_view title, const std::wstring_view content, const std::wstring_view ok, const std::wstring_view cancel);
