...
template <>
struct std::formatter<winrt::Mercatec::Services::Auths::Models::UserAccount, wchar_t>
{
    ...
    auto format(const winrt::Mercatec::Services::Auths::Models::UserAccount& user_account, FormatContext& format_context)
    {
...
namespace winrt
{
    inline hstring to_hstring(const winrt::Mercatec::Services::Auths::Models::UserAccount& user_account)
    {
...
inline std::wostream& operator<<(std::wostream& stream, const winrt::Mercatec::Services::Auths::Models::UserAccount& user_account)
{
