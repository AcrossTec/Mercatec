...
namespace winrt::Mercatec::Helpers::ViewModels::implementation
{
    ...
    public:
        ...
        fire_and_forget LogException(const std::wstring_view source, const std::wstring_view action, const hresult code, const std::wstring_view message) const noexcept;
